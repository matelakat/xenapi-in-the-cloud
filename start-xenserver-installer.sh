...
cat > /root/startinstaller << EOF
#!/bin/bash
kexec -l /opt/xs-install/boot/xen -t multiboot-x86 --append="dom0_max_vcpus=1-2 dom0_mem=max:752M com1=115200,8n1 console=com1,vga" \
